    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', djmoney.models.fields.MoneyField(blank=True, decimal_places=4, default_currency='EUR', max_digits=14)),
                ...
                ('products', models.ManyToManyField(related_name='_bill_products_+', to='products.Product')),
